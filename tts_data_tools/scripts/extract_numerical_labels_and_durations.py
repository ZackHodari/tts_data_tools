...
from tts_data_tools.scripts.save_features import save_durations, save_numerical_labels
...
def extract_numerical_labels_and_durations(file_ids, lab_dir, state_level, question_file, upsample):
    ...
    def extract(file_id, _lab_dir, _state_level, _question_set, _upsample):
        ...
        return numerical_label, duration
...
def process(lab_dir, id_list, out_dir, state_level, question_file, upsample, calculate_normalisation):
    ...
    numerical_labels, durations = extract_numerical_labels_and_durations(
        file_ids, lab_dir, state_level, question_file, upsample)
