...
def create_utterances(festival_dir, file_ids, sentences, out_dir):
    scm_commands = []
...
def process_file(festival_dir, txt_file, out_dir):
    ...
    create_utterances(festival_dir, file_ids, sentences, out_dir)


def process_dir(festival_dir, txt_dir, id_list, out_dir):
...
def process(festival_dir, txt_file=None, txt_dir=None, id_list=None, out_dir=None):
    ...
    if txt_file is not None:
        process_file(festival_dir, txt_file, out_dir)

    if txt_dir is not None:
        process_dir(festival_dir, txt_dir, id_list, out_dir)
...
def main():
    ...
    process(args.festival_dir, args.txt_file, args.txt_dir, args.id_list, args.out_dir)
